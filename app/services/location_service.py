...
class LocationService:
    ...
    def get_all_locations(self) -> List[Dict]:
        """Fetch all predefined warehouse masters."""
        ...
        if not locations:
            defaults = ["Main Warehouse", "North Facility", "South Warehouse", "Cold Storage"]
    ...
    def create_location(self, name: str) -> str:
        """Add a new physical warehouse to the master list."""
